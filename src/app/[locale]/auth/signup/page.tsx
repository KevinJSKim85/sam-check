...
import { registerWithEmailAction, socialSignInAction } from '@/app/[locale]/auth/actions';
...
export default function SignupPage() {
  ...
  const [registerState, registerAction, registerPending] = useActionState(registerWithEmailAction, {});
        ...
        <CardContent className="space-y-8">
          ...
          <section className="space-y-3">
            ...
            <form action={registerAction} className="space-y-3">
              ...
              {registerState.error ? <p className="text-sm text-red-600">{t(registerState.error)}</p> : null}
              <Button type="submit" size="lg" className="w-full" disabled={!requiredChecked || registerPending}>
